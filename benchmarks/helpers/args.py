...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--array-size", type=parse_tuple, default=(10, 10, 1, 10, 10, 10), help="Size of the test array")
    parser.add_argument("--chunk-size", type=parse_tuple, default=(10, 5, 1, 1, 1, 1), help="Chunk size for writing data")
